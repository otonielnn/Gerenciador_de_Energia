...
from energia import salvando_dados_cadastro, carregar_dados
...
def carregar_tabela(tabela):
    ...
    for linha in dados:
        tabela.insert('', 'end', text=linha[0], values=(linha[1], linha[2], linha[3]))
...
def menu_janela():
    ...
    botao_dados_energia = ttk.Button(global_frame_menu, text='Remover Cadastro')
...
def cadastro_janela():
    ...
    entrada_nome = ttk.Entry(global_frame_cadastro)
    ...
    entrada_uso_energia = ttk.Entry(global_frame_cadastro)
    ...
    entrada_producao_energia = ttk.Entry(global_frame_cadastro)
    ...
    entrada_preco_kwd = ttk.Entry(global_frame_cadastro)
